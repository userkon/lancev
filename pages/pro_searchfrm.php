...
<?php
          ...
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <div class="card-body">
          <?php 
            $query = 'SELECT PRODUCT_ID, PRODUCT_CODE, NAME,DESCRIPTION, COUNT(`QTY_STOCK`) AS "QTY_STOCK", COUNT(`ON_HAND`) AS "ON_HAND",PRICE, c.category_name FROM product p join category c on p.category_id=c.category_id WHERE PRODUCT_CODE ='.$_GET['id'];
            $result = mysqli_query($db, $query) or die(mysqli_error($db));
