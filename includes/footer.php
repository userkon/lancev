...
<div id="overlay" onclick="off()">
    <div id="text" onclick="event.stopPropagation()">
        <div class="name">
...
<script>
    function on() {
        ...
        requestAnimationFrame(() => {
            overlay.querySelector('#text').classList.add('modal-enter-active');
        });
    }

    function off() {
        const overlay = document.getElementById("overlay");
        overlay.querySelector('#text').classList.remove('modal-enter-active');
        overlay.querySelector('#text').classList.add('modal-enter');
        
        setTimeout(() => {
            overlay.style.display = "none";
            overlay.querySelector('#text').classList.remove('modal-enter');
        }, 300);
    }
